        ...
        <div class="col-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    @endif
                    <h4 class="card-title">Tambah Data Menu {{ $resto->nama }}</h4>
                    <p class="card-description">
                        Form ini digunakan untuk menambahkan menu baru
                    </p>
                    <form action="{{ route('menu.resto.store',$resto->id) }}" method="post" class="forms-sample" enctype="multipart/form-data">
                    @csrf
